...
/**
 * Exception levée lorsqu'une partie d'échecs ne peut pas être sauvegardée.
 *
 * <p>Cette exception est lancée lorsque :
 * <ul>
 *   <li>L'écriture de la partie échoue</li>
 *   <li>Le stockage n'est pas disponible</li>
 *   <li>Les données de la partie sont invalides</li>
 * </ul>
 *
 * @author crios
 */
