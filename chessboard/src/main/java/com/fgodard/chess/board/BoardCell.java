...
public enum BoardCell {
    ...
    A1(0, 0, "a1", BoardColor.BLACK), B1(1, 0, "b1", BoardColor.WHITE), C1(2, 0, "c1", BoardColor.BLACK), D1(3, 0, "d1", BoardColor.WHITE), E1(4, 0, "e1", BoardColor.BLACK), F1(5, 0, "f1", BoardColor.WHITE), G1(6, 0, "g1", BoardColor.BLACK), H1(7, 0, "h1", BoardColor.WHITE),
    ...
    A8(0, 7, "a8", BoardColor.WHITE), B8(1, 7, "b8", BoardColor.BLACK), C8(2, 7, "c8", BoardColor.WHITE), D8(3, 7, "d8", BoardColor.BLACK), E8(4, 7, "e8", BoardColor.WHITE), F8(5, 7, "f8", BoardColor.BLACK), G8(6, 7, "g8", BoardColor.WHITE), H8(7, 7, "h8", BoardColor.BLACK);
